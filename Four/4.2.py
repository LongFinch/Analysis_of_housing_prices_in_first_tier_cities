...
# Bar plot for average prices of one-bedroom, two-bedroom, and three-bedroom apartments for each city
sns.barplot(x='城市', y='均价', hue='户型', data=city_df)

# 设置图表标题和标签
plt.title('各城市不同户型的平均租金')
plt.xlabel('城市')
plt.ylabel('平均租金(元)')
