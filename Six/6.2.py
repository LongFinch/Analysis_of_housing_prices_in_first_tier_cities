...
# 指定城市文件所在的目录
directory_path = '../Two/cleaned_data/北京_cleaned.csv'
...
# 仅选择指定district的数据，例如'西直门'
df = df[df['district'] == '西直门']
...
# 将城市名作为新的一列
result['city'] = directory_path.split('_')[0]
...
for i, direction in enumerate(directions):
    ...
    for pos, value in zip(positions, direction_data['price_per_m2']):
        ax.text(pos, value + 0.5, f'{value:.1f}', ha='center', va='bottom', fontsize=10)

# 设置图形属性
ax.set_title('均价对比（西直门地区）')
ax.set_xlabel('城市')
